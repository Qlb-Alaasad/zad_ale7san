...
export default function LoginPage() {
  ...
  return (
    <AuthLayout title="تسجيل الدخول" subtitle="أهلاً بك من جديد في أكاديمية زاد الإحسان">
      ...
      <div className="my-6 flex items-center gap-3">
        ...
        <span className="text-charcoal-400 text-sm">أو</span>
        <div className="flex-1 h-px bg-cream-300" />
      </div>

      <button onClick={handleGoogleLogin} disabled={loading} className="btn btn-outline w-full disabled:opacity-50">
        <GoogleIcon />
